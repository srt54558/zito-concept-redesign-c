  ...
  <main>
    ...
    <section id="zusammenarbeit" class="section">
      ...
      <div class="mini-grid">
        ...
        <article>
          <svg class="icon" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/><rect width="20" height="14" x="2" y="6" rx="2"/></svg>
...
<style>
  ...
  .site-header {
    ...
    background: oklch(0.99 0.004 90 / 0.9);
  ...
  .logo-mark {
    ...
    padding: 0.2rem;
    background: white;
    border: 1px solid oklch(0.82 0.016 80);
  }
  ...
  .btn-primary {
    color: white;
    background: linear-gradient(120deg, oklch(0.59 0.15 32), oklch(0.64 0.14 52));
    box-shadow: 0 8px 20px -12px oklch(0.44 0.09 30 / 0.8);
  }

  .btn-ghost {
    color: oklch(0.24 0.025 78);
    border: 1px solid oklch(0.8 0.016 84);
